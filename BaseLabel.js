const BaseLabel = [
  ...
  {
    name: 'Лид',
    description: '<p>Город в Герцогстве Ориджин. Лиллидей - владеет холмистыми предгорьями на западе герцогства и получал прибыли с овечьей шерсти.</p><p>Владелец: Лиллидеи</p>',
