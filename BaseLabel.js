const BaseLabel = [
  ...
  },
  {
    ...
    description: '<p>Могер Бакли разочаровался службой у Леди Магды Лабелин. С помощью Ассасина Родриго, он нанял корабль и 70 головрезов из разных шимерийских банд с целью ограбить один из кораблей Лабелинов, тайно перевозивший золото.</p>',
