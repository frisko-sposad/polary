const BaseLabel = [
  ...
  {
    name: 'Изерин',
    description: '<p>Город в Шиммери, принадлежавший Второму Из Пяти - аббату обители Максимиана-у-Бездны. <Br>Находится под охраной наёмников Бригады Святого Страуса.</p>',
  ...
  {
    name: 'Дар №17',
    description: '<p>Найденные известные предметы:<br>- Святая Сфера<br>- Капля Солнца - кулон владычицы Ингрид.<br>- Предмет в форме цветка клевера.<br>- Чрево  - самый крупный изо всех Священных Предметов. </p>',
